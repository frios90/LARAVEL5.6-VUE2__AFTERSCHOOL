                    ...
                    <div class="breadcomb-wp">
                      ...
                      <div class="breadcomb-ctn">
                        ...
                        <p class="subtitle">
                          ...
                          <span class="bread-ntd">Aprendices</span>
                        </p>
                      </div>
                    </div>
                  </div>                 
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="breadcomb-wp">
                      ...
                      <div class="breadcomb-ctn">
                        <h2>Datos del Alumno {{name}} </h2>
                        <p>Formulario para la gestión de datos de un Alumno.</p>
                      </div>
                    </div>
                  </div>
...
export default {
  ...
  created() {
    this.getRegions();
    var params = { profile: "alumn" };
    this.getDataTable("/user-table-list", params);
    this.columns = ["rut", "name", "attorney.email", "attorney.name", "actions"];
    this.options.headings = {
      rut: "Rut",
      name: "Nombre",
      "attorney.email": "Correo Apoderado",
      "attorney.name": "Apoderado",
      actions: "Acciones"
    };
  ...
  methods: {
    ...
    openForm(e_p, user = false) {
      ...
      if (user) {
        ...
        this.getCommunes(user.region_id)
    ...
    async postalumn() {
      ...
      await axios
        ...
        .then(response => {
          self.getDataTable("/user-table-list", { profile: "alumn" })
          self.openTable()
