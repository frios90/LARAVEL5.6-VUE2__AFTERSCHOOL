                    ...
                    <div class="breadcomb-wp">
                      ...
                      <div class="breadcomb-ctn">
                        ...
                        <p class="subtitle">
                          ...
                          <span class="bread-ntd">Administradores</span>
                        </p>
                      </div>
                    </div>
                  </div>
  ...
  methods: {
    ...
    async postadmin() {
      ...
      await axios
        ...
        .then(response => {
          self.getDataTable("/user-table-list", { profile: "admin" })
          self.openTable()
